...
{
    public class ToDoCommand : AsyncCommandBase
    {
        ...
        public ToDoCommand(HomeViewModel viewModel, IArticleService articleService, IArticleDetailsService articleDetailsService, ITaskService taskService)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var taskIds = tasks.Select(a => a.ArticleID);
            var mergedData =
                from a in articoles
                where !taskIds.Contains(a.Id)
