...
{
    public class InProgressCommand : AsyncCommandBase
    {
        ...
        public InProgressCommand(HomeViewModel viewModel, IArticleService articleService, IArticleDetailsService articleDetailsService, ITaskService taskService)
        {
