...
{
    public class AllCommand : AsyncCommandBase
    {
        ...
        public AllCommand(HomeViewModel viewModel, IArticleService articleService, IArticleDetailsService articleDetailsService, ITaskService taskService)
        {
